...
public abstract class Network {
    ...
    /**
     * Sends the message to all processes except for current process.
     * 
     * @param message the message to send
     */
    public abstract void sendToOthers(Message message);
    ...
    protected final void fireReceiveMessage(Message message, int sender) {
        ...
        if (!handled) {
            System.out.println("Unhandled message: " + message.getType().toString());
