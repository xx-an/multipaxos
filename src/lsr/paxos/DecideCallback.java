...
public class DecideCallback {
    ...
    public DecideCallback(Replica replica, int executeUB) {
    ...
    private void executeRequests() {
		...
		while (true) {
		    ...
		    if (ci == null) {
		        logger.info("Cannot continue execution. Next instance not decided: {}", executeUB);
		        return;
			}
			Request[] requests = Request.unpack(ci.getValue());
    ...
    static final Logger logger = LoggerFactory.getLogger(DecideCallback.class);
}
