...
public class SnapshotMaintainer implements LogListener {
        ...
        dispatcher.dispatch(new Runnable() {
            public void run() {
                ...
                if (logger.isInfoEnabled()) {
                    logger.info("Snapshot made. next instance: " + snapshot.getNextInstanceId() +
                ...
                if (logger.isInfoEnabled()) {
                    logger.info("Snapshot received from state machine for:" +
    ...
    public void logSizeChanged(int newsize) {
        ...
        if (logger.isInfoEnabled()) {
            logger.info("Calculated log size for " + logByteSize);
        }
        ...
        if (!askedForSnapshot) {
            ...
            logger.info("Asking state machine for shapshot");
        ...
        if (!forcedSnapshot) {
            ...
            logger.info("Forcing state machine to do shapshot");
