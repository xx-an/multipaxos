...
public final class Configuration {
    ...
    public int getIntProperty(String key, int defValue) {
        ...
        if (str == null) {
            logger.info("Property not found: " + key + ". Using default value: " +
                        defValue);
            return defValue;
        }
    ...
    public boolean getBooleanProperty(String key, boolean defValue) {
        String str = configuration.getProperty(key);
        if (str == null) {
            logger.info("Property not found: " + key + ". Using default value: " + defValue);
            return defValue;
        }
    ...
    public double getDoubleProperty(String key, double defultValue) {
        String str = configuration.getProperty(key);
        if (str == null) {
            logger.info("Property not found: " + key + ". Using default value: " + defultValue);
            return defultValue;
        }
